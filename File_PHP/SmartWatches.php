        ...
        <div class="container-fluid">
          <div class="row">
              <div class="col-md-3" style="background-color: rgb(238,230,224);">  
                    <div class="card shadow" style="background-color: rgb(238,230,224);" >         
                      <img class="card-img-top rounded " src="../Image/Smart_Watches/apple3.jpg" alt="Card image cap">
                      <div class="card-body text-left">
                        <p class="card-text" style="text-align: left;">
                          The Minimalist Three-Hand Brown Leather Watch<br>
                          4.599.000 VND
                        </p>
                      </div>
                    </div>          
              ...
              <div class="col-md-3" style="background-color: rgb(238,230,224);">  
                    <div class="card shadow" style="background-color: rgb(238,230,224);">
                      <img class="card-img-top rounded " src="../Image/Smart_Watches/apple4.jpg" alt="Card image cap" style="background-color: rgb(238,230,224);">
                      <div class="card-body text-left">
                        <p class="card-text" style="text-align: left;">
                          The Minimalist Three-Hand Brown Leather Watch<br>
                          4.999.000 VND
              ...
              <div class="col-md-3" style="background-color: rgb(238,230,224);">  
                    <div class="card shadow" style="background-color: rgb(238,230,224);">        
                      <img class="card-img-top rounded " src="../Image/Smart_Watches/apple7.jpg" alt="Card image cap" style="background-color: rgb(238,230,224);">
                      <div class="card-body text-left">
                        <p class="card-text" style="text-align: left;">
                          The Minimalist Three-Hand Brown Leather Watch<br>
                          4.699.000 VND
