    ...
    <div class="container" >
      <form >
          <div class="form-group">
                <label for="idProduct">Nhập Mã Sản Phẩm</label>
                <input type="text" class="form-control" id="idProduct" aria-describedby="emailHelp" placeholder="Nhập Mã Sản Phẩm">
          </div>
           <button type="submit" class="btn-block btn-primary">Nhập Mã Sản Phẩm</button>
      </form>
    </div>
