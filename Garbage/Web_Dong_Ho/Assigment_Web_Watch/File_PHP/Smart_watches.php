...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
              <div class="col-md-6" style="background-color: rgb(238,230,224);">  
                    <div class="card shadow" style="background-color: rgb(238,230,224);" >
                        ...
                        <img class="card-img-top rounded " src="../Image/Product/apple-watch-series-5-40-44mm-anh-thuc-te-day-deo-min.jpg" alt="Card image cap">
        ...
        <div class="container-fluid">
              <div class="row">
              <img src="../Image/Product/2711_SmartWatchAppleSerie5-1.jpg" >  
              </div>        
        </div>
